import React from 'react';  // import React Library
    // declaring component and passing "props" from parent component (input from user) in const NytResults component declaration below
    // within return, format and display for results from fetch are determined
    // we don't understand ternary operator regarding multimedia
